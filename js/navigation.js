...
$(document).ready(function(){
	...
	$('#btnSubmit').click(function() {
		...
		var sName = JSON.stringify(sName);
		var sEmail = JSON.stringify(sEmail);
		var sMobile = JSON.stringify(sMobile);
		var sMessage = JSON.stringify(sMessage);

		
		if (sEmail !== "" && sMessage !== "") {
			try {
				var jsondata = ''; 
				// , userEmail:sEmail, userPhone:sMobile, userMessage:sMessage};
				$.ajax({
					type: "POST",
					url: "/DataLayer/ContactusUpdate.php",
